...
if (isset($_GET['user_id'])) {
    ...
    $sql = "SELECT events.nama, events.tanggal, events.id, events.banner, events.deskripsi, events.waktu, events.lokasi, events.max_partisipan,
...
<div class="container mx-auto mt-8">
    <h1 class="text-2xl font-bold text-center mb-6"><?= htmlspecialchars($user['username']) ?>'s Event Registrations</h1>
    <div class="bg-white shadow-md rounded-lg p-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php if ($result->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p class="text-center text-gray-500">This user has not registered for any events.</p>
            <?php endif; ?>
        </div>
    </div>
</div>
